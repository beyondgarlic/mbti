...
const questions = [
    ...
    // J/P 질문
    { type: 'J/P', question: '여행짐 싸는 D-Day', options: ['A. 당일 아침 “필요한 건 현지에서 사자!” 즉흥파', 'B. 필수템 체크리스트’ 미리 완벽 준비'] },
    { type: 'J/P', question: '프로젝트 마감 앞두고', options: ['A. 데드라인 직전, 몰아치기 고수', 'B. 미리미리 일찍 시작하는 알찬 전략가'] },
    { type: 'J/P', question: '약속 잡는 스타일은?', options: ['A. 시간 장소? 당일 아침 잡는 게 쩌는 거 아니야?” 즉흥파"', 'B. 캘린더 동기화 완료, 완벽한 일정 조율!” 계획파'] }
];
